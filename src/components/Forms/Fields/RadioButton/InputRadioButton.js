...
export const InputRadioButton = ({active, register, value, index, }) => {
    return (
        <div className={`field__radio-wrapper ${active ? 'active': ''}`}>
            <input
